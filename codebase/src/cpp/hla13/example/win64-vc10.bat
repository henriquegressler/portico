...
cl /I"%PORTICO_RTI_HOME%\include\hla13" /DRTI_USES_STD_FSTREAM /EHsc main.cpp ExampleCPPFederate.cpp ExampleFedAmb.cpp "%PORTICO_RTI_HOME%\lib\vc10\libRTI-NG64.lib" "%PORTICO_RTI_HOME%\lib\vc10\libFedTime64.lib"
goto finish
