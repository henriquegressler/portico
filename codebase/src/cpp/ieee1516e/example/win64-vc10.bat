...
cl /I"%PORTICO_RTI_HOME%\include\ieee1516e" /DRTI_USES_STD_FSTREAM /EHsc main.cpp ExampleCPPFederate.cpp ExampleFedAmb.cpp "%PORTICO_RTI_HOME%\lib\vc10\librti1516e64.lib" "%PORTICO_RTI_HOME%\lib\vc10\libfedtime1516e64.lib"
goto finish
...
:execute
SHIFT
set PATH=%PORTICO_RTI_HOME%\jre\bin\server;%PORTICO_RTI_HOME%\bin\vc10;%PATH%
